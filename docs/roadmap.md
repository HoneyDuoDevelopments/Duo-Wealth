...
|2026-04-29|Empirical source verification gate complete|Six sources characterized (Stooq, yfinance, MacroTrends, Wayback, WIKI/Nasdaq, SEC+OpenFIGI). Open questions #4, #5, #6 resolved. Evidence committed to tests/empirical/output/. See docs/research/topics/Source_empirical_verification_price_sources.md.|
|2026-05-01|Phase 1 Stage 2 — fja05680 universe loader complete|1,246 instruments seeded into instrument_master / ticker_identifier_history / universe_membership. issuer_id intentionally NULL pending Stage 1 SEC bridge. Hard cases verified: GOOG/GOOGL separate instruments, BRK/A/BRK/B separate instruments, DELL two intervals (2013 going-private + 2024 re-listing), CELG delisted 2019-11-21. Source confidence 'inferred' for pre-2005, 'probable' for 2005+.|
